  ...
  return (
    <header className='bookHeader'>
      <div className='bookHeader__wrapper'>
        <div className='bookHeader__logo'>
        ...
        <div className='bookHeader__contents'>
          <div className='bookHeader__main'>
            <h1 className='section__heading section__heading--bookHeader'>
              Reservations
            </h1>
            <p className='paragraph__text paragraph__text--bookHeader'>
              We can’t wait to host you. If you have any special requirements
              please feel free to call on the phone number below. We’ll be happy
              to accommodate you.
            </p>
          </div>
          <Button className='btn btn--bookHeader' text='Reserve Now' />
        </div>
      </div>
    </header>
  );
